...
# total_epochs = 20
total_epochs = 10
load_from = 'saved_models/our_trained_models/detpro_stage2_finetune.pth'
evaluation = dict(metric=['track'], start=9999, interval=1, resfile_path='results/ovtrack_r50_reverse_without_inference')
