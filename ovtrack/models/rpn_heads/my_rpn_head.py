...
class MyRPNHead(AnchorHead):
    ...
    def __init__(self,
        ...
        self.only_use_n_layers = only_use_n_layers
        ...
        for level_idx in range(len(cls_score_list)):
            ...
            level_ids.append(
                scores.new_full((scores.size(0), ),
                                level_idx,
                                dtype=torch.long))
        if self.only_use_n_layers != -1:
            mlvl_scores = mlvl_scores[:self.only_use_n_layers]
            mlvl_bbox_preds = mlvl_bbox_preds[:self.only_use_n_layers]
            mlvl_valid_anchors = mlvl_valid_anchors[:self.only_use_n_layers]
            level_ids = level_ids[:self.only_use_n_layers]
